            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="text" name="name" id="name" value={formData.name} onChange={handleChange}
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" required />
              </div>
              <div>
              ...
              <div>
                <label htmlFor="propertyType" className="block text-sm font-medium text-gray-700">{t.contact.form.propertyType}</label>
              ...
              {submitted && <p className="text-sm text-green-600 font-medium">✓ {t.contact.successMessage}</p>}
              <div>
