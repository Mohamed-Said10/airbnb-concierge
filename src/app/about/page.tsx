          ...
          <div className="bg-gray-50 py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="max-w-lg mx-auto lg:max-w-xl">
              ...
              <p className="mt-2 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight">
                Your Trusted Airbnb Management Partner
              </p>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Excellence in Service</p>
                </dt>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Personal Touch</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Revenue Optimization</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
