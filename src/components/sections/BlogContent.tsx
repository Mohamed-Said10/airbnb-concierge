        ...
        <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-2">
          ...
          <div className="bg-primary-600 py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex lg:items-center">
            <div className="max-w-lg mx-auto lg:max-w-xl">
              ...
              <p className="mt-3 text-lg text-primary-200">{t.blog.newsletterText}</p>
              <div className="mt-8">
                <form className="sm:flex">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full px-5 py-3 placeholder-gray-500 focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-700 focus:ring-white focus:border-white sm:max-w-xs rounded-md"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <div className="mt-10 lg:mt-0">
            <div className="text-sm text-primary-600 uppercase tracking-wide font-semibold">
