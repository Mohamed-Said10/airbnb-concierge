...
export const translations = {
  en: {
    ...
    guestIdentityPromo: {
      ...
      description:
        'Comply with Moroccan law effortlessly. Guests fill their ID information, upload their document, and sign digitally — all in one secure, guided form.',
    ...
    guestIdentity: {
      ...
      pageSubtitle:
        'As required by Moroccan law, please complete your registration form. Your information will be kept confidential and used solely for legal compliance.',
  ...
  fr: {
    nav: {
      ...
      blog: 'Blog',
      contact: 'Contact',
      guestIdentity: 'Voyageur enregistrement',
    },
    hero: {
    ...
    guestIdentityPromo: {
      ...
      description:
        'Respectez la législation marocaine sans effort. Les clients remplissent leurs informations, téléchargent leur document et signent numériquement — tout en un formulaire guidé et sécurisé.',
    ...
    guestIdentity: {
      ...
      pageSubtitle:
        'Conformément à la législation marocaine, veuillez remplir votre fiche d\'enregistrement. Vos informations resteront confidentielles et seront utilisées uniquement à des fins légales.',
      ...
      personal: {
        ...
        idExpiryDate: 'Date d\'expiration du document',
        address: 'Adresse permanente',
      ...
      upload: {
        ...
        frontSide: 'Recto',
        backSide: 'Verso (facultatif)',
        clickToUpload: 'Cliquez pour télécharger',
        dragDrop: 'ou glisser-déposer',
        fileTypes: 'PNG, JPG jusqu\'à 5 Mo',
        preview: 'Aperçu',
      ...
      multi: {
        ...
        traveler: 'Voyageur',
        addTraveler: '+ Ajouter un autre voyageur',
        removeTraveler: 'Supprimer le voyageur',
