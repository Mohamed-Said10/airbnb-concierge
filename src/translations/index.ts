  ...
  en: {
    ...
    guestIdentity: {
      ...
      errors: {
        ...
        invalidDocument: 'Enter a document number between 3 and 50 characters.',
        ...
        invalidPhoto: 'Use a JPG, PNG, or WebP image no larger than 5 MB.',
  ...
  fr: {
    ...
    guestIdentity: {
      ...
      errors: {
        ...
        invalidName: 'Saisissez un nom contenant entre 2 et 100 caractères.',
        invalidDocument: 'Saisissez un numéro de document contenant entre 3 et 50 caractères.',
        invalidStayDates: "La date de départ doit être après la date d'arrivée.",
        pastCheckIn: "La date d'arrivée ne peut pas être dans le passé.",
        photoRequired: "Veuillez télécharger le recto de votre document d'identité.",
        invalidPhoto: 'Utilisez une image JPG, PNG ou WebP de 5 Mo maximum.',
